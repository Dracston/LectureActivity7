...
namespace LectureActivity7
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //you can set values to an index using examples below:
            ...
            Console.WriteLine($"Length of array1: [array1.Length]\n"); // displays the lenght/size of the arra; output: 5
            //arrat 2 declaration with values
            int[] array2 = new int[] { 1, 3, 5, 7, 9 }; //declares a single-dimensional array elemet with values
             ...
             * array2[3] -> returns 7
             * array2[4] -> returns 9d
             * array2[5] -> returns RUNTIME ERROR: OutOfBoundsException
             * 
             ...
             * when accessing an index that does not exit
             */
            ...
            Console.WriteLine($"\ngrades Averages: {GetAverage(grades)}");
            ...
            Console.WriteLine($"Count of alpahbet: {alphabet.Count}");// displays the count/size of the list; output: 5
            ...
            alphabet.Remove('C'); // remove a specific vallue somewhere inside the collection
        ...
        {
            //you can use a for-loop or other looping statement for array traversals
